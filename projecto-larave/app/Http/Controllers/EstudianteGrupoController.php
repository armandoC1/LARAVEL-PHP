    ...
    public function index(Request $request)
{
    ...
    // Filtrar por estudiante_id si está presente en la solicitud
    if ($request->filled('estudiante_id') && is_numeric($request->estudiante_id)) {
        $query->where('estudiante_id', $request->estudiante_id);
    }

    // Ordenar por id descendente y paginar los resultados
    ...
    public function update(Request $request, $id)
{
    ...
    return redirect()->route('estudiantes_grupos.index')->with('success', 'Estudiante-Grupo actualizado exitosamente');
